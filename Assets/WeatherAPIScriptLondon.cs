...
using TMPro;
public class WeatherAPIScriptLondon : MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=7aa5622713859da2cc0675481bf0ca13&units=imperial";
